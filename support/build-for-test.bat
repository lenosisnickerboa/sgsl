...
py -m PyInstaller --onefile --icon=src/app/assets/icon.ico --add-data "src/app/assets/icon.ico;app/assets" --add-data "src/app/assets/test_build.marker;app/assets" --collect-data ttkbootstrap --collect-submodules ttkbootstrap src/sgsl.py
