...
def build_game_defaults() -> Config[ConfigIndex]:
    defaults = {
        ...
        ConfigIndex.MP_ROUNDTIME_DEFUSE: ConfigItem(
            name="mp_roundtime_defuse",
            visible_name="Round time, defuse maps (min)",
            type=ConfigType.INTEGER,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
            tooltip="Round length in minutes, on defuse maps",
            value=5,
            range=Range(min_value=1, max_value=60),
        ),
        ConfigIndex.MP_ROUNDTIME_HOSTAGE: ConfigItem(
            name="mp_roundtime_hostage",
            visible_name="Round time, hostage maps (min)",
            type=ConfigType.INTEGER,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
            tooltip="Round length in minutes, on hostage maps",
            value=5,
            range=Range(min_value=1, max_value=60),
        ),
        ...
        ConfigIndex.MP_RESPAWN_IMMUNITYTIME: ConfigItem(
            name="mp_respawn_immunitytime",
            visible_name="Respawn immunity time",
            type=ConfigType.INTEGER,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
        ...
        ConfigIndex.MP_BUY_DURING_IMMUNITY: ConfigItem(
            ...
            visible_name="Allow buying during immunity",
            type=ConfigType.BOOLEAN,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
        ...
        ConfigIndex.MP_BUY_ALLOW_GUNS: ConfigItem(
            ...
            visible_name="Allow buying guns",
            type=ConfigType.BOOLEAN,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
            tooltip="Let players buy guns",
            value=True,
        ),
        ConfigIndex.MP_BUY_ALLOW_GRENADES: ConfigItem(
            name="mp_buy_allow_grenades",
            visible_name="Allow buying grenades",
            type=ConfigType.BOOLEAN,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
            tooltip="Let players buy grenades",
            value=True,
        ),
        ConfigIndex.MP_ROUND_RESTART_DELAY: ConfigItem(
            name="mp_round_restart_delay",
            visible_name="Round restart delay (s)",
            type=ConfigType.INTEGER,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
        ...
        ConfigIndex.MP_TEAM_INTRO_TIME: ConfigItem(
            ...
            visible_name="Team intro time (s)",
            type=ConfigType.INTEGER,
            config_type=ConfigDeliveryType.SERVER_CFG_FILE,
            tooltip="How long, in seconds, the team intro sequence lasts before a match starts",
            value=0,
            range=Range(min_value=0),
        ),
